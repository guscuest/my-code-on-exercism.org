...
CLASS zcl_itab_nesting IMPLEMENTATION.
  ...
  METHOD perform_nesting.
    ...
    DATA: artist      TYPE artist_album_nested_type,
            album       TYPE album_song_nested_type,
            song        TYPE song_nested_type.
    ...
    LOOP AT artists ASSIGNING FIELD-SYMBOL(<artist>).
      ...
      ) TO nested_data ASSIGNING FIELD-SYMBOL(<nested_artist>).
      ...
      LOOP AT albums ASSIGNING FIELD-SYMBOL(<album>)
        ...
        ) TO <nested_artist>-albums
          ASSIGNING FIELD-SYMBOL(<nested_album>).
